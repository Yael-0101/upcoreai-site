      ...
      es: {
        ...
        secciones: [
          ...
          },
          {
            ...
            parrafos: [
              "Sería raro escribir esto y no decir los nuestros. Son cerrados, no rangos: el asistente de WhatsApp son $6,000 USD —con una versión esencial de $3,000 que atiende solo en español—, el agente de voz $6,500 y el sitio con agenda $4,500. El panel, si lo quieres, $3,000. De la segunda pieza en adelante hay 15% menos.",
      ...
      en: {
        ...
        secciones: [
          ...
          },
          {
            ...
            parrafos: [
              "It would be odd to write all this and not state ours. They are fixed, not ranges: the WhatsApp assistant is $6,000 USD —with an essential version at $3,000 that answers in Spanish only—, the voice agent $6,500 and the site with booking $4,500. The dashboard, if you want it, $3,000. From the second piece onward there is 15% off.",
