...
export function DescargarPDF() {
  return (
    <button
      ...
      className="no-print inline-flex min-h-[44px] items-center rounded-full border border-[rgba(242,231,219,0.25)] px-6 py-2.5 text-sm font-semibold text-mocha transition-colors hover:border-clay hover:text-clay-bright"
    >
      📄 Descargar en PDF
    </button>
  );
